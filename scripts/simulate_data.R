...
save(jain, file=here("data/jain.rda"))
...
save(aggregation, file=here("data/aggregation.rda"))
...
save(asymmetric, file=here("data/asymmetric.rda"))
...
save(noisycircles, file=here("data/noisycircles.rda"))